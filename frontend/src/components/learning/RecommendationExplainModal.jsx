            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-300">
                  ...
                  <span className="text-lg font-extrabold">{explanation.relevance_score || 94}%</span>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-foreground/90 leading-relaxed bg-accent/20 p-3 rounded-xl border border-border/50">

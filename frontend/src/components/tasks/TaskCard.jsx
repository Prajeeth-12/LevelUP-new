...
export const TaskCard = ({
  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-2xl border p-4 bg-white dark:bg-card shadow-sm hover:shadow-md transition-all duration-200 ${
        isDone
          ? 'border-gray-200 dark:border-border/60 opacity-75 bg-gray-50/50 dark:bg-card/40'
          : isCurrent
          ? 'border-violet-200/80 dark:border-violet-800/40 ring-1 ring-violet-500/10'
          : 'border-gray-200 dark:border-border hover:border-gray-300 dark:hover:border-zinc-700'
      }`}
    >
      {/* Top Header: Priority Badge + 3-Dots Settings */}
      ...
      <div className="flex items-center justify-between gap-2 pt-3 mt-3 border-t border-gray-100 dark:border-border/60 text-xs">
        {isToDo && (
          <button
